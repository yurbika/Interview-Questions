...
- createPortal()`,
  ...
  },
  {
    ...
    - RxJS is a reactive programming library, it is used as a tool to accomplish asynchronouse task.
    => Redux uses the reactive paradigm because the store is reactive
    => store observes actions from a distance and chages itself`,
  },
  {
  ...
  },
  {
    ...
    answer: `- export the store
    - with ssr use a thunk middleware`,
  },
  {
    question: `What are the downsides of Redux over Flux?`,
    answer: `- multiple stores !== store
    - singleton dispatcher !== no dispatcher
    - mutable state !== immutable state
    - component subscribes to stores !== container component utilize connect`,
  },
  {
    question: `What is the purpose of the constants in Redux?`,
    answer: `- It helps keep the naming consistent because all action types are gathered in a single place
    - easier error handling`,
  },
  {
    question: `How to make Ajax request in Redux?`,
    answer: `With Redux-Thunk`,
  },
  {
    question: `How to reset state in redux?`,
    answer: `Create an action dispatcher with reset`,
  },
];
